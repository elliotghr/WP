...
function the_pet_clinic_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('the_pet_clinic_logo_padding',array(
		'sanitize_callback'	=> 'esc_html'
	));
	$wp_customize->add_control('the_pet_clinic_logo_padding',array(
		'label' => __('Logo Padding','the-pet-clinic'),
		'section' => 'title_tagline'
	));

	$wp_customize->add_setting('the_pet_clinic_logo_top_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'the_pet_clinic_sanitize_float'
	));
	$wp_customize->add_control('the_pet_clinic_logo_top_padding',array(
		'type' => 'number',
		'description' => __('Top','the-pet-clinic'),
		'section' => 'title_tagline',
	));

	$wp_customize->add_setting('the_pet_clinic_logo_bottom_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'the_pet_clinic_sanitize_float'
	));
	$wp_customize->add_control('the_pet_clinic_logo_bottom_padding',array(
		'type' => 'number',
		'description' => __('Bottom','the-pet-clinic'),
		'section' => 'title_tagline',
	));

	$wp_customize->add_setting('the_pet_clinic_logo_left_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'the_pet_clinic_sanitize_float'
	));
	$wp_customize->add_control('the_pet_clinic_logo_left_padding',array(
		'type' => 'number',
		'description' => __('Left','the-pet-clinic'),
		'section' => 'title_tagline',
	));

	$wp_customize->add_setting('the_pet_clinic_logo_right_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'the_pet_clinic_sanitize_float'
	));
	$wp_customize->add_control('the_pet_clinic_logo_right_padding',array(
		'type' => 'number',
		'description' => __('Right','the-pet-clinic'),
		'section' => 'title_tagline',
	));
	...
	$wp_customize->add_setting('the_pet_clinic_hide_show_topbar',array(
    	'default' => false,
    	'sanitize_callback'	=> 'the_pet_clinic_sanitize_checkbox'
	));
	$wp_customize->add_control('the_pet_clinic_hide_show_topbar',array(
   	'type' => 'checkbox',
   	'label' => __('Show / Hide Topbar','the-pet-clinic'),
	...
	$wp_customize->add_setting('the_pet_clinic_facility_section_padding',array(
      'default' => '',
      'sanitize_callback'	=> 'the_pet_clinic_sanitize_float'
   ));
   $wp_customize->add_control('the_pet_clinic_facility_section_padding',array(
      'type' => 'number',
      'label' => __('Section Top Bottom Padding','the-pet-clinic'),
      'section' => 'the_pet_clinic_facilities_section',
   ));
	...
	$wp_customize->add_setting('the_pet_clinic_show_back_totop',array(
 		'default' => true,
   	'sanitize_callback'	=> 'the_pet_clinic_sanitize_checkbox'
	));
	$wp_customize->add_control('the_pet_clinic_show_back_totop',array(
   	'type' => 'checkbox',
   	'label' => __('Show / Hide Back to Top','the-pet-clinic'),
